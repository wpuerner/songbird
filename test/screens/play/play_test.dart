...
void main() {
  ...
  group('Play screen result tests', () {
    testWidgets('Got it button adds correct result', (WidgetTester tester) async {
  ...
  group('Play screen navigation tests', () {
    testWidgets('When words are available to play, route to play screen', (WidgetTester tester) async {
      await _pumpPlayScreen(tester);
    ...
    testWidgets('When no words are available, route to end screen', (WidgetTester tester) async {
